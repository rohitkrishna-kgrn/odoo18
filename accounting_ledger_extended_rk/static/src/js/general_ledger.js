...
export class GeneralPartnerLedger extends Component {
    setup() {
    ...
    async loadLedger() {
        ...
        this.state.data = await this.orm.call(
            "account.ledger.extended.rk", "get_general_ledger",
    ...
    async printPdf() {
        await this.action.doAction({
            ...
            report_name: "accounting_ledger_extended_rk.report_general_ledger",
            report_file: "accounting_ledger_extended_rk.report_general_ledger",
    ...
    async printXlsx() {
        await download({
            ...
            data: {
                ...
                report_name: "General Ledger - " + this.state.selected.name,
            },
        });
    }
...
GeneralPartnerLedger.template = "accounting_ledger_extended_rk.GeneralPartnerLedger";
registry.category("actions").add("rk_general_ledger", GeneralPartnerLedger);
