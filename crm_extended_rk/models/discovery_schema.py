...
EINVOICING_SECTIONS = [
        ...
        'fields': [
            ...
            {'key': 'documentScope', 'label': 'Invoicing scope currently relevant', 'type': 'checkbox',
             ...
             'options': opt('Outbound customer invoices', 'Inbound supplier invoices', 'Credit notes',
                            ...
                            'Not sure yet')},
            {'key': 'currentNeedType', 'label': 'Current need / engagement intent', 'type': 'checkbox',
             'required': True, 'help': 'What you are looking for from KGRN — select all that apply',
    ...
    },
    {
        ...
        'fields': [
            {'key': 'postGoLiveSupportLevel', 'label': 'Post-go-live support expectation', 'type': 'checkbox',
             'required': True, 'help': 'Level of ongoing support expected after go-live — select all that apply',
