{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'mis_report_kgrn/static/src/scss/mis_date_range_filter.scss',
            'mis_report_kgrn/static/src/xml/mis_date_range_filter.xml',
            'mis_report_kgrn/static/src/js/mis_date_range_filter.js',
        ],
    },
    'installable': True,
    'application': True,
